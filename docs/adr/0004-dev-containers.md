...
We will adopt the **VS Code Dev Containers** specification to define and manage the development environment. This will be implemented using a `.devcontainer/` directory containing:

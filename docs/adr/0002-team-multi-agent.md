...
We will refactor the system to use a **multi-agent team architecture** using `agno.team.Team` in "coordinate" mode. This involves breaking down the problem into specialized roles handled by different agents:
